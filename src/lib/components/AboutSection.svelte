<script lang="ts">
	import farm from '$lib/assets/taajem-farm.jpeg';
</script>

<section class="py-20 bg-white">
	<div class="container mx-auto px-6">
		<h2 class="text-4xl md:text-5xl text-center text-blue-600 mb-12 uppercase tracking-wide">About The ATV Club</h2>
		<div class="grid md:grid-cols-2 gap-12 items-center">
			...
			<img
				src={farm}
				alt="Scenic trails in Goa"
				class="rounded-2xl shadow-2xl object-cover w-full h-170"
			/>
		</div>
	</div>
</section>